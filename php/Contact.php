...
class Contact
{
    ...
    public function addNumber($post)
    {
        ...
        if (mysqli_num_rows($check) > 0) {
            setFlashMsg('error', 'Nomor tersebut sudah ada di database!');
            back('numbers.php');
        }
        if (mysqli_query($this->db, "INSERT INTO nomor VALUES (null,'$name','$number','$message','$this->username')")) {
            setFlashMsg('success', 'Nomor berhasil di tambahkan!');
            back('numbers.php');
        }
    }
    ...
    public function deleteNumber($id)
    {
        if (mysqli_query($this->db, "DELETE FROM nomor WHERE id = '$id'")) {
            setFlashMsg('success', 'Nomor berhasil di hapus');
            back('numbers.php');
        }
    }
    ...
    public function import($file)
    {
        ...
        if (!in_array($ext, $allow)) {
            setFlashMsg('danger', 'Format harus XLSX');
            back('numbers.php');
        }
        ...
        if (move_uploaded_file($file["tmp_name"], $target)) {
            ...
            setFlashMsg('success', 'Berhasil Import ');
            back('numbers.php');
        }
        setFlashMsg('danger', 'Kesalahan system (100)');
        back('numbers.php');
    }
    ...
    public function getContacts($nomor)
    {
        ...
        setFlashMsg('success', 'Kontak berhasil diambil');
        back('numbers.php');
    }
